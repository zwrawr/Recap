...
def rotateWaypoint(waypoint, instruction):
	b = math.radians(instruction['i'])
	x = math.cos(b * waypoint[0]) - math.sin(b * waypoint[1])
	y = math.sin(b * waypoint[0]) - math.cos(b * waypoint[1])

	return (x,y)

def moveWaypoint(waypoint, instruction):
